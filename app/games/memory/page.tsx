...
export default function MemoryGame() {
  ...
  useEffect(() => {
    if (matches === CARD_SYMBOLS.length && gameStarted) {
      setGameWon(true);
  ...
  }, [matches, gameStarted, timer, moves, bestTime, bestMoves]);
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-black border-4 border-[#ff10f0] neon-border p-8 pixel-corners">
          ...
          <div className="flex justify-center mb-6">
            <div className="grid grid-cols-4 gap-4 max-w-xl p-6 bg-black border-4 border-[#00ffff]" style={{boxShadow: '0 0 20px #00ffff'}}>
